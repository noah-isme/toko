...
export const LazyProductImageGallery = lazy(() => 
  import('@/components/product-image-gallery').then((mod) => ({ default: mod.ProductImageGallery }))
);
...
export const LazyLoyaltyDashboard = lazy(() => 
  import('@/entities/loyalty/ui/LoyaltyDashboard').then((mod) => ({ default: mod.LoyaltyDashboard }))
);

export const LazyPushPreferencesCard = lazy(() => 
  import('@/entities/web-push/ui/PushPreferencesCard').then((mod) => ({ default: mod.PushPreferencesCard }))
);

export const LazyPushNotificationBanner = lazy(() => 
  import('@/entities/web-push/ui/PushNotificationBanner').then((mod) => ({ default: mod.PushNotificationBanner }))
);

export const LazyAdvancedFilterSidebar = lazy(() => 
  import('@/entities/search/ui/AdvancedFilterSidebar').then((mod) => ({ default: mod.AdvancedFilterSidebar }))
);

export const LazyAdvancedSearchResults = lazy(() => 
  import('@/entities/search/ui/AdvancedSearchResults').then((mod) => ({ default: mod.AdvancedSearchResults }))
);
...
export const LazyProductRecommendations = lazy(() => 
  import('@/components/product-recommendations').then((mod) => ({ default: mod.ProductRecommendations }))
);
...
export const LazyCategoryQuickNav = lazy(() => 
  import('@/components/landing/category-quick-nav').then((mod) => ({ default: mod.CategoryQuickNav }))
);

export const LazyFlashSaleSection = lazy(() => 
  import('@/components/landing/flash-sale-section').then((mod) => ({ default: mod.FlashSaleSection }))
);
...
export function LazyWrapper({ 
  ...
  return (
    <Suspense fallback={fallback || <LazySkeleton variant={fallbackVariant} className={className} />}>
      {children}
    </Suspense>
  );
}
