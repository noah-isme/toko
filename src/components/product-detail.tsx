...
import { LazyWrapper, LazyProductRecommendations, LazyProductQASection } from '@/components/lazy-components';
...
function ProductDetailContent({ slug }: ProductDetailProps) {
  ...
  return (
    <>
      ...
      <LazyWrapper>
        <LazyProductRecommendations productId={data.id} />
      </LazyWrapper>
      <LazyWrapper>
        <LazyProductQASection productId={data.id} />
      </LazyWrapper>
    </>
  );
}
