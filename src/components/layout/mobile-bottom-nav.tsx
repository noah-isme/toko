...
const navItems = [
  ...
  { href: '/cart' as Route, label: 'Cart', icon: ShoppingCart, showBadge: true },
  { href: '/favorites' as Route, label: 'Favorit', icon: Heart },
  { href: '/account' as Route, label: 'Akun', icon: User },
];
