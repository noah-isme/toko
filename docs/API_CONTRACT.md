...
> [!IMPORTANT] > **API Contract has been moved to a modular structure.**
> Please refer to [docs/contracts/README.md](contracts/README.md) for the latest documentation.

## Quick Links

- [General Info & Authentication](contracts/README.md)
- [Auth Endpoints](contracts/auth.md)
- [Catalog](contracts/catalog.md)
...
- [Frontend Guides](contracts/guides.md)
