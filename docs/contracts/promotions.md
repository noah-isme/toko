...
- Flash-sale prices, discount basis points, campaign timestamps, and remaining stock come from the API. The client does not fabricate campaign discounts or timers.
